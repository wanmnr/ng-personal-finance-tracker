...
@Component({
  selector: 'app-finance-dashboard-declarative',
  standalone: true,
  imports: [CommonModule, FinancialCalculationsPipe],
  template: `
    <div class="dashboard">
      <div class="card">
        <h3>Total Balance</h3>
        <div class="amount">
          {{
            transactions() | financialCalculations : 'totalBalance' | currency
          }}
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="category-list">
          ...
          financialCalculations:'categorySpending'); track $index) {
      ...
      <div class="card">
        ...
        <div class="trend-list">
          @for (trend of (transactions() |
          financialCalculations:'monthlyTrend':timeframe()); track trend.date) {
...
export class FinanceDashboardDeclarativeComponent {
