...
export class BudgetComponent implements OnInit {
  ...
  addBudget(): void {
    ...
    dialogRef
      ...
      .subscribe((result) => {
        if (result) {
          this.budgetService.addBudget(result).subscribe((budget) => {
  ...
  editBudget(budget: Budget): void {
    ...
    dialogRef
      ...
      .subscribe((result) => {
        if (result) {
          this.budgetService.updateBudget(result).subscribe((updatedBudget) => {
  ...
  private showOverBudgetWarning(): void {
    this.snackBar.open(
      'Warning: Total spending exceeds total budget!',
      'Close',
      {
        duration: 5000,
